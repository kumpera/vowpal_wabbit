...
void predict_or_learn_with_confidence(confidence& c G_GNUC_UNUSED, single_learner& base, example& ec)
{
  float threshold = 0.f;
...
void return_confidence_example(vw& all, confidence& c G_GNUC_UNUSED, example& ec)
{
