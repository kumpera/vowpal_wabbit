...
struct BaseState
{
  ...
  virtual BaseState<audit>* Key(Context<audit>& ctx, const char* str, rapidjson::SizeType len, bool copy G_GNUC_UNUSED)
  {
...
public:
  ...
  void init(vw* all G_GNUC_UNUSED)
  {
  ...
  BaseState<audit>* Key(Context<audit>& ctx, const char* str, rapidjson::SizeType len, bool copy G_GNUC_UNUSED)
  {
    ctx.key = str;
    ctx.key_length = len;
    return this;
...
struct LabelState : BaseState<audit>
{
  ...
  BaseState<audit>* String(Context<audit>& ctx, const char* str, rapidjson::SizeType len G_GNUC_UNUSED, bool copy)
  {
...
public:
  ...
  BaseState<audit>* Null(Context<audit>& ctx G_GNUC_UNUSED)
  {
  ...
  BaseState<audit>* EndArray(Context<audit>& ctx, rapidjson::SizeType elementCount G_GNUC_UNUSED)
  {
...
public:
  ...
  BaseState<audit>* Uint(Context<audit>& ctx G_GNUC_UNUSED, unsigned f)
  {
    output_array->push_back((T)f);
    return this;
  }

  BaseState<audit>* Float(Context<audit>& ctx G_GNUC_UNUSED, float f)
  {
    output_array->push_back((T)f);
    return this;
  }
...
public:
  ...
  BaseState<audit>* String(Context<audit>& ctx G_GNUC_UNUSED, const char* str, rapidjson::SizeType length, bool copy G_GNUC_UNUSED)
  {
...
public:
  ...
  BaseState<audit>* StartObject(Context<audit>& ctx G_GNUC_UNUSED)
  {
    // TODO: improve validation
    return this;
  }

  BaseState<audit>* EndObject(Context<audit>& ctx G_GNUC_UNUSED, rapidjson::SizeType memberCount G_GNUC_UNUSED)
  {
    // TODO: improve validation
    return this;
  }

  BaseState<audit>* Key(Context<audit>& ctx G_GNUC_UNUSED, const char* str, rapidjson::SizeType length, bool copy G_GNUC_UNUSED)
  {
    if (length == 1)
    {
      switch (str[0])
...
struct VWReaderHandler : public rapidjson::BaseReaderHandler<rapidjson::UTF8<>, VWReaderHandler<audit>>
{
  ...
  bool RawNumber(const char* str G_GNUC_UNUSED, rapidjson::SizeType length G_GNUC_UNUSED, bool copy G_GNUC_UNUSED) { return false; }
